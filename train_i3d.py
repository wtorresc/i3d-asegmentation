...
def run(init_lr=0.1, max_steps=64e3, mode='rgb', root='../data/BL_and_PL', 
        train_split='../ms-tcn/data/BL_and_PL/groundTruth/annotations.json', batch_size=1, save_model=''):
    ...
    dataset = Dataset(train_split, 'training', root, mode, train_transforms,save_dir='saveds')
    ...
    while steps < max_steps:#for epoch in range(num_epochs):
        ...
        for phase in ['train']:#, 'val']:
            ...
            if phase == 'val':
                print ('{} Loc Loss: {:.4f} Cls Loss: {:.4f} Tot Loss: {:.4f}'.format(phase, 
                            tot_loc_loss/num_iter, tot_cls_loss/num_iter, 
